...
export class SpotifyService {
  ...
  constructor(private http: Http) {
    ...
    this.config.clientId = SPOTIFY_CONFIG.clientId;
    this.config.clientSecret = SPOTIFY_CONFIG.clientSecret;
    this.config.sdkKey = SPOTIFY_CONFIG.sdkKey;
    this.config.authToken = localStorage.getItem('spotify-token');
    this.config.scope = ['user-follow-modify', 'user-follow-read', 'playlist-read-private', 'playlist-read-collaborative', 'playlist-modify-public', 'playlist-modify-private', 'user-library-read', 'user-library-modify', 'user-read-private'];
  }
...
*/
  ...
  getCurrentSong(type: string, options?: SpotifyOptions) {
    options = options || {};
    options.type = type;
    return this.api({
      method: 'get',
...
*/
  ...
  private api(requestOptions: HttpRequestOptions) {
    requestOptions.headers.set('Authorization', 'Bearer ' + this.config.authToken);
